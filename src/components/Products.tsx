    ...
    return (
        <Container className="products">
            ...
            <Row className="products__content">
                ...
                <Col sm='3'><Products_icons title='Плакаты' image='images/products-icons/icon_5.svg'></Products_icons></Col>
                <Col sm='3'><Products_icons title='Чертежи' image='images/products-icons/icon_6.svg'></Products_icons></Col>
                <Col sm='3'><Products_icons title='Фотографии' image='images/products-icons/icon_7.svg'></Products_icons></Col>
                <Col sm='3'><Products_icons title='Визитки' image='images/products-icons/icon_8.svg'></Products_icons></Col>
            </Row>
        </Container>
    )
}